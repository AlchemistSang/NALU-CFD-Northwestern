...
#ifndef IntensityEquationSystem_h
#define IntensityEquationSystem_h
...
class IntensityEquationSystem : public EquationSystem {

public:

  IntensityEquationSystem(EquationSystems& equationSystems,
                         const bool managePNG);
  virtual ~IntensityEquationSystem();
  ...
  ScalarFieldType *intensity_;		//SEL
