...
#ifndef MarangoniLSMomentumSrcElemSuppAlg_h
#define MarangoniLSMomentumSrcElemSuppAlg_h
...
class MarangoniLSMomentumSrcElemSuppAlg : public SupplementalAlgorithm
{
public:

  MarangoniLSMomentumSrcElemSuppAlg(
    Realm &realm,
    double rho0,
    double rho1);

  virtual ~MarangoniLSMomentumSrcElemSuppAlg() {}
