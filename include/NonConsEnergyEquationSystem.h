...
#ifndef NonConsEnergyEquationSystem_h
#define NonConsEnergyEquationSystem_h
...
class NonConsEnergyEquationSystem : public EquationSystem {

public:

  NonConsEnergyEquationSystem(
    EquationSystems& equationSystems,
    const double minT,
    const double maxT,
    const bool outputClippingDiag);
  virtual ~NonConsEnergyEquationSystem();
