...
#ifndef ComputeNCMdotDarcyElemAlgorithm_h
#define ComputeNCMdotDarcyElemAlgorithm_h
...
class ComputeNCMdotDarcyElemAlgorithm : public Algorithm
{
public:

  ComputeNCMdotDarcyElemAlgorithm(
    Realm &realm,
    stk::mesh::Part *part,
