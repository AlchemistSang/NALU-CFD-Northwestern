...
// Class Definition
//==========================================================================
// NCScalarMassBDF2NodeSuppAlg - BDF2 for scalar mass
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
NCScalarMassBDF2NodeSuppAlg::NCScalarMassBDF2NodeSuppAlg(
  Realm &realm,
...
//--------------------------------------------------------------------------
void
NCScalarMassBDF2NodeSuppAlg::setup()
{
...
//--------------------------------------------------------------------------
void
NCScalarMassBDF2NodeSuppAlg::node_execute(
  double *lhs,
  double *rhs,
  stk::mesh::Entity node)
{
  ...
  rhs[0] -= rhoNp1 * (gamma1_*qNp1 + gamma2_*qN + gamma3_*qNm1)*dualVolume/dt_;
  lhs[0] += lhsTime;
}
