...
// Class Definition
//==========================================================================
// NCScalarMassBackwardEulerNodeSuppAlg - base class for algorithm
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
NCScalarMassBackwardEulerNodeSuppAlg::NCScalarMassBackwardEulerNodeSuppAlg(
  Realm &realm,
...
//--------------------------------------------------------------------------
void
NCScalarMassBackwardEulerNodeSuppAlg::setup()
{
...
//--------------------------------------------------------------------------
void
NCScalarMassBackwardEulerNodeSuppAlg::node_execute(
  double *lhs,
  double *rhs,
  stk::mesh::Entity node)
{
  ...
  rhs[0] -= rhoNp1 * (qNp1 - qN)*dualVolume/dt_;
  lhs[0] += lhsTime;
}
