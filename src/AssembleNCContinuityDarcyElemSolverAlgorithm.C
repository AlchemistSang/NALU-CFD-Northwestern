...
// Class Definition
//==========================================================================
// AssembleNCContinuityDarcyElemSolverAlgorithm - add LHS/RHS for continuity
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
AssembleNCContinuityDarcyElemSolverAlgorithm::AssembleNCContinuityDarcyElemSolverAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
...
//--------------------------------------------------------------------------
void
AssembleNCContinuityDarcyElemSolverAlgorithm::initialize_connectivity()
{
...
//--------------------------------------------------------------------------
void
AssembleNCContinuityDarcyElemSolverAlgorithm::execute()
{
      ...
      for ( int ip = 0; ip < numScsIp; ++ip ) {
        ...
        for ( int ic = 0; ic < nodesPerElement; ++ic ) {
          ...
          for ( int j = 0; j < nDim; ++j ) {
            ...
            lhsfac += -p_dndx_lhs[offSetDnDx+j]*p_scs_areav[ip*nDim+j]*invPermIp;
            //lhsfac += -p_dndx_lhs[offSetDnDx+j]*p_scs_areav[ip*nDim+j]/rhoIp;
          }
