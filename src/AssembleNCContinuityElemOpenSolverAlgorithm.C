...
// Class Definition
//==========================================================================
// AssembleNCContinuityElemOpenSolverAlgorithm - lhs for continuity open bc
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
AssembleNCContinuityElemOpenSolverAlgorithm::AssembleNCContinuityElemOpenSolverAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
...
//--------------------------------------------------------------------------
void
AssembleNCContinuityElemOpenSolverAlgorithm::initialize_connectivity()
{
...
//--------------------------------------------------------------------------
void
AssembleNCContinuityElemOpenSolverAlgorithm::execute()
{
    ...
    for ( stk::mesh::Bucket::size_type k = 0 ; k < length ; ++k ) {
      ...
      for ( int ip = 0; ip < numScsBip; ++ip ) {
        ...
        for ( int ic = 0; ic < nodesPerElement; ++ic ) {
          ...
          p_lhs[rowR+ic] += r*asq*inv_axdx*invrhoBip;
        }

        // final mdot
        mdot += -projTimeScale*invrhoBip*((pBip-pScs)*asq*inv_axdx + noc*includeNOC);
