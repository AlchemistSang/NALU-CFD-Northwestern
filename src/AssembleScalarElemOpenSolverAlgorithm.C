...
// Class Definition
//==========================================================================
// AssembleNCScalarElemOpenSolverAlgorithm - lhs for scalar open bc
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
AssembleNCScalarElemOpenSolverAlgorithm::AssembleNCScalarElemOpenSolverAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
...
//--------------------------------------------------------------------------
void
AssembleNCScalarElemOpenSolverAlgorithm::initialize_connectivity()
{
...
//--------------------------------------------------------------------------
void
AssembleNCScalarElemOpenSolverAlgorithm::execute()
{
  ...
  for ( stk::mesh::BucketVector::const_iterator ib = face_buckets.begin();
    ...
    for ( stk::mesh::Bucket::size_type k = 0 ; k < length ; ++k ) {
      ...
      for ( int ip = 0; ip < numScsBip; ++ip ) {
        ...
        const double densNN      = *stk::mesh::field_data(densityNp1, nearestNode);
        ...
        if ( tmdot > 0.0 ) {
          ...
          p_rhs[nearestNode] -= aflux * densNN;

          // upwind lhs
          p_lhs[rowR+nearestNode] += densNN * tmdot*pecfac*alphaUpw;
