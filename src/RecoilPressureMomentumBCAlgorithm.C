...
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
RecoilPressureMomentumBCAlgorithm::RecoilPressureMomentumBCAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
...
//--------------------------------------------------------------------------
void
RecoilPressureMomentumBCAlgorithm::initialize_connectivity()
{
...
//--------------------------------------------------------------------------
void
RecoilPressureMomentumBCAlgorithm::execute()
{
    ...
    for ( size_t k = 0 ; k < length ; ++k ) {
      ...
      for ( int ip = 0; ip < numScsBip; ++ip ) {
        ...
        for ( int i = beginPos_; i < endPos_; ++i )
        {
          ...
          p_rhs[indexR] += recoilPressure * areaNorm;     
        }
      }// end for (ip)
