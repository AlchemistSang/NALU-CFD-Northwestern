...
// Class Definition
//==========================================================================
// ComputeNCMdotElemAlgorithm - interior mdor for elem continuity
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
ComputeNCMdotElemAlgorithm::ComputeNCMdotElemAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
...
//--------------------------------------------------------------------------
void
ComputeNCMdotElemAlgorithm::execute()
{
      ...
      for ( int ip = 0; ip < numScsIp; ++ip ) {
        ...
        for ( int ic = 0; ic < nodesPerElement; ++ic ) {
          ...
          for ( int j = 0; j < nDim; ++j ) {
            ...
            p_invrhoGpdx[j] += r* ( p_Gpdx[nDim*ic+j] / nodalRho );
...
//                    - projTimeScale*(p_dpdxIp[j]/rhoIp - invrhoIp*p_GpdxIp[j]))*p_scs_areav[ip*nDim+j];
        ...
        // MJ: this is modifying massFlowRate_ from stk::mesh::field_data
        mdot[ip] = tmdot;
...
//--------------------------------------------------------------------------
void
ComputeNCMdotElemAlgorithm::assemble_edge_mdot()
{
