...
// Class Definition
//==========================================================================
// NCMomentumMassBackwardEulerNodeSuppAlg - lumped mass BE
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
NCMomentumMassBackwardEulerNodeSuppAlg::NCMomentumMassBackwardEulerNodeSuppAlg(
  Realm &realm)
...
//--------------------------------------------------------------------------
void
NCMomentumMassBackwardEulerNodeSuppAlg::setup()
{
...
//--------------------------------------------------------------------------
void
NCMomentumMassBackwardEulerNodeSuppAlg::node_execute(
  double *lhs,
  double *rhs,
  stk::mesh::Entity node)
{
  ...
  for ( int i = 0; i < nDim; ++i ) {
    rhs[i] += -rhoNp1*(uNp1[i] - uN[i])*dualVolume/dt_ -dpdx[i]*dualVolume;
