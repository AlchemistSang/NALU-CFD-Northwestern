...
// Class Definition
//==========================================================================
// MomentumMultiPhaseBoussinesqSrcNodeSuppAlg - -rho*beta*(T-Tref) g
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
MomentumMultiPhaseBoussinesqSrcNodeSuppAlg::MomentumMultiPhaseBoussinesqSrcNodeSuppAlg(
  Realm &realm)
...
//--------------------------------------------------------------------------
void
MomentumMultiPhaseBoussinesqSrcNodeSuppAlg::setup()
{
...
//--------------------------------------------------------------------------
void
MomentumMultiPhaseBoussinesqSrcNodeSuppAlg::node_execute(
  double */*lhs*/,
  double *rhs,
  stk::mesh::Entity node)
{
  ...
  const double fac = -rho*beta_*(temperature - tRef_)*dualVolume;
